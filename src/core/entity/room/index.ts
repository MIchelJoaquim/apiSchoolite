...
export class Room {
    ...
    private constructor(parameters: { id: Id, description: Description, acronym: Acronym, capacity: number}){
...
static create(parameters: {id: Id, description: Description, acronym: Acronym,capacity:  number}){
