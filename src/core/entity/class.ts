...
export default class Class {
  ...
  static create(props: IProps) {
    if (props[ClassField.Capacity] <= 0)
      throw new Error('[Class] A capacidade deve ser maior ou igual a zero');
    if (props[ClassField.MaxAge] > 40)
      throw new Error('[Class] A idade máxima é de 39 anos');
